...
<div class=" flex mt-3 mr-3 ml-3  justify-center shadow-md  rounded-t-2xl p-4 flex-col">
    <h1 class="text-xl font-bold ml-6">Comments</h1>
    <div id="scview" class="overflow-auto h-48 sm:h-60 md:h-96">
        <ul >
          <div class="mt-6 flex-col space-x-6 flex-wrap ">
...
<!-- comment form -->
<div class="flex ml-3 mr-3 mb-2 items-center justify-center shadow-md rounded-b-md">
